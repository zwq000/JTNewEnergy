...
namespace JTNE.Protocol.Test.MessageBody
{
    public class JTNE_0x03Test
    {
        ...
        public void Test2()
        {
            var data = "1407160C260901040507003A00001A0A00640063030602007B02030202010201004100370300EC00640203020042023605085800650308AE006F0C9600030102030D1B221A0A560D086502".ToHexBytes();
            JTNE_0x03 jTNE_0X03 = JTNESerializer.Deserialize<JTNE_0x03>(data);
            JTNE_0x02 jTNE_0X02 = jTNE_0X03.Supplement;
            Assert.NotEmpty(jTNE_0X02.Values);
