...
namespace JTNE.Protocol.Test.MessageBody {
    ...
    public class JTNE_0x02_0xA1_Formatter : IJTNEFormatter<JTNE_0x02_0xA1> {
        public JTNE_0x02_0xA1 Deserialize (ReadOnlySpan<byte> bytes, out int readSize) {
            int offset = 0;
            JTNE_0x02_0xA1 jTNE_0X02_0XA1 = new JTNE_0x02_0xA1 ();
            //jTNE_0X02_0XA1.TypeCode = bytes.ReadByteLittle( ref offset);
            jTNE_0X02_0XA1.Length = bytes.ReadUInt16 (ref offset);
            jTNE_0X02_0XA1.UserName = bytes.ReadString (ref offset, 12);
            jTNE_0X02_0XA1.Age = bytes.ReadUInt16 (ref offset);
            readSize = offset;
        ...
        public int Serialize (ref byte[] bytes, int offset, JTNE_0x02_0xA1 value) {
            ...
            offset += bytes.WriteUInt16 (offset, value.Length);
            offset += bytes.WriteString (offset, value.UserName, 12);
            offset += bytes.WriteUInt16 (offset, value.Age);
            return offset;
        }
    }
    /// <summary>
    ...
    public class JTNE_0x02_0xA2_Formatter : IJTNEFormatter<JTNE_0x02_0xA2> {
        public JTNE_0x02_0xA2 Deserialize (ReadOnlySpan<byte> bytes, out int readSize) {
            int offset = 0;
            JTNE_0x02_0xA2 jTNE_0X02_0XA2 = new JTNE_0x02_0xA2 ();
            jTNE_0X02_0XA2.Length = bytes.ReadUInt16 (ref offset);
            jTNE_0X02_0XA2.CompanyName = bytes.ReadString (ref offset, 20);
            readSize = offset;
        ...
        public int Serialize (ref byte[] bytes, int offset, JTNE_0x02_0xA2 value) {
            offset += bytes.WriteByte (offset, value.TypeCode);
            offset += bytes.WriteUInt16 (offset, value.Length);
            offset += bytes.WriteString (offset, value.CompanyName, 20);
            return offset;
        }
    }
