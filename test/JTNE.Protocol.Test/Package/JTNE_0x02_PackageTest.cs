...
namespace JTNE.Protocol.Test.Package {
    public class JTNE_0x02_PackageTest {
        ...
        [Fact]
        public void Test2 () {
            var data = "".ToHexBytes ();
            JTNEPackage jTNEPackage = JTNESerializer.Deserialize (data);
            JTNE_0x02 jTNE_0X02 = jTNEPackage.Body as JTNE_0x02;
            ...
            JTNE_0x02_0x04 jTNE_0X02_0X04 = jTNE_0X02.Values.First (p => p.TypeCode == JTNE_0x02_Body.JTNE_0x02_0x04) as JTNE_0x02_0x04;
            ...
            JTNE_0x02_0x05 jTNE_0X02_0X05 = jTNE_0X02.Values.First (p => p.TypeCode == JTNE_0x02_Body.JTNE_0x02_0x05) as JTNE_0x02_0x05;
            ...
            Assert.Equal ((PositioStatus)0x01, jTNE_0X02_0X05.PositioStatus);

            JTNE_0x02_0x06 jTNE_0X02_0X06 = jTNE_0X02.Values.First (p => p.TypeCode == JTNE_0x02_Body.JTNE_0x02_0x06) as JTNE_0x02_0x06;
            ...
            JTNE_0x02_0x07 jTNE_0X02_0X07 = jTNE_0X02.Values.First (p => p.TypeCode == JTNE_0x02_Body.JTNE_0x02_0x07) as JTNE_0x02_0x07;
            ...
            JTNE_0x02_0x08 jTNE_0X02_0X08 = jTNE_0X02.Values.First (p => p.TypeCode == JTNE_0x02_Body.JTNE_0x02_0x08) as JTNE_0x02_0x08;
            ...
            JTNE_0x02_0x09 jTNE_0X02_0X09 = jTNE_0X02.Values.First (p => p.TypeCode == JTNE_0x02_Body.JTNE_0x02_0x09) as JTNE_0x02_0x09;
